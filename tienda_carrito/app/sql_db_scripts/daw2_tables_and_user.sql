...
-- , fechaHoraInicio timestamp not null default current_timestamp comment "Fecha de apertura del pedido"
...
-- , primary key (id)
-- , foreign key (pedido_id) references daw2_pedidos(id) on delete cascade on update cascade
